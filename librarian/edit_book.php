...
<?php $get_id = $_GET['id']; ?>
    <div class="container">
		<div class="margin-top">
			...
			<div class="span12">	
		<?php 
		/*This is where the Program will fetch the data from the database*/
	...
	<form class="form-horizontal" method="POST" action="update_books.php" enctype="multipart/form-data">
		...
		<div class="control-group">
			<!--The Fetched Book Title from the Database-->
		...
		<div class="control-group">
			...
			<select name="category_id">
				<!--The Fetched category from the Database-->
		...
		<div class="control-group">
			...
			<div class="controls">
			<!--The Fetched number of copies of books from the Database-->
		...
		<div class="control-group">
			...
			<div class="controls">
			<!--The Fetched ISBN from the Database-->
		...
		<div class="control-group">
			...
			<div class="controls">
			<!--The Fetched Copyright from the Database-->
		...
		<div class="control-group">
			...
			<div class="controls">
			<select name="status">
				<!--The Fetched Book Status from the Database-->
