...
<?php
/* $title is the Title that was submitted from the advance search modal*/
$title = $_POST['title'];
/* $author is the Author that was submitted from the advance search modal*/
$author = $_POST['author'];
?>
						...
						<h1>Books List</h1>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php 
                                  $awhere = "";
								  /* If the User submits an empty title and author submission*/
                                  if(!empty($title) && !empty($author)){
                                  	$awhere = " and (book_title LIKE  '%$title%' or and author LIKE '%$author%') ";
                                  }/* If the User submits an empty title but with author submission*/
								  elseif(!empty($title)){
                                  	$awhere = " and book_title LIKE  '%$title%' ";
                                  }/* If the User submits an empty author but with title submission*/
								  elseif(!empty($author)){
